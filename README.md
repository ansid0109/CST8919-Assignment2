...
|                     | Azure                                                                                                                                           | AWS                                                                                                                  | GCP                                                                                                                                                                                                      |
| ------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Overview            | The observability platform for Azure resources, applications, and hybrid environments.                                                          | Built into the AWS control plane  and most AWS services publish metrics to CloudWatch automatically.                 | Store, search, analyze, monitor, and alert on **logging** data from **Google** **Cloud** and AW                                                                                                          |
...
| Security/Compliance | Standard certificates.                                                                                                                          | Same.                                                                                                                | S                                                                                                                                                                                                        |
